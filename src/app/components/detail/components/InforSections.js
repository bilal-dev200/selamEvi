...
function InforSections() {
  return (
    <div className="max-w-6xl mx-20  py-12">
      {/* Top Section */}
      <div className="flex flex-col md:flex-row gap-8 mb-12">
        ...
        <div className="md:w-2/3">
         ...
         <p className="text-gray-800 mb-4 text-[14px] leading-relaxed">
      ...
      <br/> their dream homes. Starting in [Year],
          ...
          <p className="text-gray-800 mb-4 text-[14px] leading-relaxed">
            ...
            Bonorum et Malorum" after mixing <br/> the words in each sentence. The
          ...
          <br/>  printers adapted Cicero's original work, beginning with the phrase
            "dolor sit amet consectetur.<br/>  They abbreviated "dolorem" (meaning
            "pain") to "lorem," which carries no meaning in Latin. "Ipsum"
           <br/> translates to "itself," and the text frequently includes phrases such
            as "consectetur adipiscing elit" and "ut <br/> labore et dolore." These
            Latin fragments, derived from Cicero's philosophical treatise, were
            rearranged to<br/> create the standard dummy text that has become a
            fundamental tool in design and typography across<br/> generations.
                <br/>
            ...
            each <br/> sentence. The familiar "lorem ipsum dolor sit amet" text
            emerged when 16th-century printers adapted <br/> Cicero's original work,
            beginning with the phrase "dolor sit amet consectetur."
          </p>
        </div>

        {/* Right Image Section */}
        <div className="md:w-1/4 grid grid-cols-1 gap-4">
          <img
            src="/b-d2.png"
            alt="Solar panels"
            className="w-[435px] h-[200px]  object-cover "
          />
          <img
            src="/news2.png"
            alt="News"
