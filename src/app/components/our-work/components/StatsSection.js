  ...
  return (
    <div className="flex flex-col md:flex-row items-center justify-center px-6 md:px-16 py-30 bg-white">
      ...
      <div className="w-full md:w-1/2 mt-10 md:mt-0 md:ml-12">
        ...
        <p className="text-gray-600 leading-relaxed mb-4">
          Selam-Evi is a trusted Islamic charity foundation in Türkiye, devoted
          to transforming lives through compassion and service. Our work spans
          healthcare support, educational assistance, women&apos;s empowerment,
          and welfare and relief programs across Syria, Gaza, Türkiye, and
          beyond. Through every project, we aim to bring hope, dignity, and
          opportunity to those most in need.
        </p>

        <p className="text-gray-600 leading-relaxed">
          Beyond immediate relief, Selam-Evi is committed to creating long-term,
          sustainable solutions that empower families and communities. Through
          our programs, we foster self-reliance, nurture hope, and open doors to
          brighter futures. Every effort we make is guided by compassion,
          dignity, and the vision of building a world where no one is left
          behind.
        </p>
      </div>
    </div>
