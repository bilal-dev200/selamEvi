...
export default function Banner() {
  ...
  <h1 className="text-4xl sm:text-4xl md:text-5xl font-bold leading-tight text-red-500 text-center">
            Education{" "}
            <span className="text-white">for Brighter Futures</span>
          </h1>


<p className="mt-3 sm:mt-4 text-[10px] sm:text-[12px] md:text-[13px] font-light text-gray-200 tracking-wide max-w-sm sm:max-w-md md:max-w-lg mx-auto md:mx-25 text-center">       
