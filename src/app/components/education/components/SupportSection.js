        ...
        <div className="grid md:grid-cols-2 relative items-center">
          ...
          <div className="relative mt-8 md:mt-0">
            <div className="absolute md:static md:translate-y-17 bg-[#AE1C17] text-white p-6 sm:p-10 md:p-14 lg:p-16 md:h-[500px] md:w-[630px] ">
              ...
              <h2 className="text-[32px] sm:text-[38px] md:text-[40px] -mt-6 leading-tight">
              ...
              <ul className="space-y-4 text-[14px] sm:text-[15px]">
                <li className="flex items-start">
                  <span>
                    ● <span className="font-semibold">Schools Assisted</span>
                    <br />
                ...
                <li className="flex items-start">
                  <span>
                    ● <span className="font-semibold">Scholarships & Fees</span>
                    <br />
                    <span className="ml-4 text-[#FFFFFFB2]">
                ...
                <li className="flex items-start">
                  <span>
                    ● <span className="font-semibold">Teacher Training</span>
                    <br />
                    <span className="ml-4 text-[#FFFFFFB2]">
                ...
                <li className="flex items-start">
                  <span>
                    ● <span className="font-semibold">Digital Learning Access</span>
                    <br />
                    <span className="ml-4 text-[#FFFFFFB2] ">
